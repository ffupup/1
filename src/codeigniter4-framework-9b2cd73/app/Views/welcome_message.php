      ...
      <body>
        ...
        <nav>
            ...
            <div>
                ...
                <a href="index.html" class="home">Home</a><!--Call the home button using the class created before-->
            </div>
            <div>
                <a href="login.html" class="login">Login</a> |<!--This will leave a | in red between the buttons, this will stay for now as
                it is good for testing and visual purposes-->
                <a href="sign-up.html" class="signup">Register</a>
            </div>
